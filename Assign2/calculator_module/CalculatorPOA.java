 ...
 implements calculator_module.CalculatorOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("divide", new java.lang.Integer (2));
    _methods.put ("multiply", new java.lang.Integer (3));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 2:  // calculator_module/Calculator/divide
       {
         int a = in.read_long ();
         int b = in.read_long ();
         int $result = (int)0;
       ...
       case 3:  // calculator_module/Calculator/multiply
       {
         int a = in.read_long ();
         int b = in.read_long ();
         int $result = (int)0;
